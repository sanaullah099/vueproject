...
/* harmony import */ var _js_components_ContactList__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../js/components/ContactList */ "./resources/js/components/ContactList.vue");
...
Vue.use(VueAxios, (axios__WEBPACK_IMPORTED_MODULE_5___default()));
var routes = [{
  name: '/',
  path: '/',
  ...
  name: '/contacts',
  path: '/contacts',
  component: _js_components_ContactList__WEBPACK_IMPORTED_MODULE_3__.default
}];
